...
const Footer = () => {
  return (
    ...
    <img
      ...
      className="z-10 mt-0 max-w-full aspect-[5] w-[748px]"
    />
    <div className="flex gap-5 items-start mt-8 max-w-full text-center w-[755px] max-md:flex-wrap">
      ...
      <div className="flex flex-auto gap-5 mt-1.5 text-xl max-md:flex-wrap">
        ...
        <span className="flex-auto self-start mt-2.5">
          Trust Score <span className="text-2xl font-medium text-emerald-400">4.5</span> | <span className="text-2xl font-medium">300</span> reviews
        </span>
      </div>
    </div>
    <h2 className="mt-10 text-xl font-medium text-center uppercase max-md:max-w-full">
      <span className="uppercase">Expertefy</span> - Your Trusted Partner for Expert Insights
      <span>Connecting you to top-tier professionals across diverse industries.</span>
    </h2>
