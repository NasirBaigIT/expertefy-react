      ...
      >
        <div className="flex flex-col w-full max-w-[1120px] max-md:max-w-full">
          <div className="flex w-full max-md:flex-col">
            ...
            <form
              className="flex flex-col w-5/12 self-end pb-8 ml-20 max-w-full bg-white rounded-xl shadow-xl max-md:w-full max-md:mt-10 max-md:ml-2.5"
              onSubmit={(e) => handleSubmit(e)}
            >
              <div className="flex gap-2.5 px-4 py-2 text-xl font-semibold text-white whitespace-nowrap bg-light-indigo rounded-t-xl shadow-sm max-md:flex-wrap">
                <img
                  alt="Expertefy Logo"
                  src={logo}
              ...
              <div className="flex flex-col px-5 max-md:max-w-full">
                ...
                <input
                  type="text"
                  id="name"
                  className="box-border flex relative flex-col shrink-0 p-2.5 rounded-md border-2 border-indigo-900 border-solid"
                ...
                <textarea
                  id="projectScope"
                  className="box-border flex relative flex-col shrink-0 px-2.5 pt-2.5 pb-4 my-5 rounded-md border-2 border-indigo-900 border-solid"
