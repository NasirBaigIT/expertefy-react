...
function ExpertJourney() {
  return (
    <div className="flex justify-center items-center px-16 py-10 text-white bg-dark-indigo max-md:px-5 mt-12">
      <div
        className={`flex gap-4 max-md:flex-wrap ${
          useCheckMobileScreen() ? "w-1/1" : "w-1/2"
        }`}
      >
        {useCheckMobileScreen() ? null : (
        ...
        <div className="flex flex-col font-medium max-md:max-w-full">
          ...
          <div className="flex overflow-hidden relative flex-col py-9 mt-7 w-full text-xl min-h-[479px]">
            {useCheckMobileScreen() ? (
              <div className="flex relative flex-col px-7">
