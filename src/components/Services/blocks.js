    ...
    <section className="flex justify-center items-center py-16 w-full max-md:px-5 max-md:mt-10 max-md:max-w-full">
      <div className="flex flex-col w-full max-w-[1120px] max-md:max-w-full">
        ...
        <div className="drop-shadow-xl">
          <Reveal>
            <div className="flex flex-col flex-wrap justify-center content-start items-center p-5 mt-7  bg-dark-indigo rounded-xl w-full max-w-[1120px] max-md:max-w-full">
                ...
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                    <div className="text-lg text-white capitalize max-md:mt-2 max-md:max-w-full">
                      ...
                      actionable insights. Cut through the clutter of market
                      noise with ease. Our suite of services includes
                      comprehensive online interviews and face-to-face meetings
                      designed to provide you with the depth of understanding
                      required to make informed decisions swiftly.
                    </div>
                  </div>
              ...
              <div className="flex flex-col flex-wrap justify-center content-start px-3.5 mt-4 w-full max-w-[1013px] max-md:max-w-full">
                <div className="flex gap-3 text-lg font-medium text-center text-white max-md:flex-wrap">
                  ...
                  <div className="flex flex-col px-2">
                    ...
                    />
                    <div className="mt-4">
                      Custom recruitment for each project
                    </div>
                  </div>
                  <div className="flex flex-col px-2">
                    <img
        ...
        <div className="drop-shadow-xl">
          <Reveal>
            <div className="flex flex-col flex-wrap justify-center content-start items-center p-5 mt-7  bg-dark-indigo rounded-xl drop-shadow-2xl w-full max-w-[1120px] max-md:max-w-full">
              <div className="self-stretch max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                    <div className="text-lg text-white capitalize max-md:mt-2 max-md:max-w-full">
                      ...
                      behalf. Following each interview, we provide you with
                      manual transcript and audio recording of the interview,
                      capturing the essence of the expert's insights and
                      allowing you to revisit the discussion at your
                      convenience. This service is crafted to save you time and
                      resources and to help you tackle the complexities of
        ...
        <div className="drop-shadow-xl">
          <Reveal>
            <div className="flex flex-col flex-wrap justify-center content-start items-center p-5 mt-7  bg-dark-indigo rounded-xl drop-shadow-2xl w-full max-w-[1120px] max-md:max-w-full lg:mb-32 max-md:mb-16">
              <div className="self-stretch max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                    <div className="text-lg text-white capitalize max-md:mt-2 max-md:max-w-full">
