    ...
    <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col grow pt-5 max-md:mt-8">
        <div className="flex flex-col bg-white rounded-none shadow-xl">
          <div className="z-10 justify-center items-start px-5 py-3 -mt-5 text-xl font-medium text-white bg-light-indigo rounded-xl shadow-sm max-md:pr-5">
            {title}
          </div>
  ...
  return (
    <div className="flex flex-col w-full max-md:max-w-full">
      <header className="flex flex-col pt-3.5 w-full bg-white shadow-lg max-md:max-w-full">
        ...
        <div className="mt-3 w-full bg-light-indigo shadow-xl min-h-[2px] max-md:max-w-full" />
      </header>
      <ImageSection
        src="https://cdn.builder.io/api/v1/image/assets/TEMP/0be351684f05368462fa1482b791375d598adeb0cb258ea88af126f514b82c8e?apiKey=3756b57bedc84c2cbd55485bb12ec63c&"
        className="self-center mt-28 w-full aspect-[2] max-w-[1120px] max-md:mt-10 max-md:max-w-full"
      />
      <section className="flex justify-center items-center px-16 py-16 mt-52 w-full bg-dark-indigo max-md:px-5 max-md:mt-10 max-md:max-w-full">
        <div className="flex flex-col items-center w-full max-w-[1120px] max-md:max-w-full">
          <div className="text-5xl font-medium leading-10 text-center text-white capitalize">
            What we offer
          </div>
          <div className="mt-4 text-lg text-center text-white max-md:max-w-full">
            ...
            to unparalleled expertise. Utilize insights from our network to make
            informed decisions, gain a competitive advantage, and stay abreast
            of industry trends.
          </div>
          <div className="flex-wrap justify-center content-start mt-16 max-w-full w-[816px] max-md:mt-10 max-sm:flex max-sm:flex-col">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <ImageSection
                ...
                className="grow shrink-0 max-w-full aspect-[1.23] w-[170px] max-md:mt-6 max-sm:px-5 max-sm:mx-auto max-sm:w-[195px]"
              />
              <ServiceItem
                ...
                text="Customized & targeted research"
              />
              <ServiceItem
                ...
                text="list of available experts for review in 24h"
              />
              <ImageSection
          ...
          <div className="self-stretch mt-10 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <OfferItem
                title="Interviews"
                text="Engage with subject matter experts across all industries. • Virtual and face-to-face meetings • One-on-one session or a group setting • Free audio recording & transcript"
                imgSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/a1841942f0768bcb9ef5a2d21ee239bf6b77366e2abbcd8d58a2595d8da6181b?apiKey=3756b57bedc84c2cbd55485bb12ec63c&"
              />
              <OfferItem
                title="Expertefy-led Calls"
                text="Expertefy can moderate interviews on your behalf. Our skilled moderators ensure that your discussions are focused and effective, covering critical topics of interest. • Audio recording and manual transcript"
                imgSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/19987e9e93ca0ed001d8c6206fdb2e7d142b2c517c833468e0359dc89478f666?apiKey=3756b57bedc84c2cbd55485bb12ec63c&"
              />
              <OfferItem
                title="B2B Survey"
                text="We offer a robust B2B survey service that develops and distributes custom surveys to targeted respondent pools, collecting high-quality data tailored to your specific research needs. • Qualitative and quantitative • Programming & hosting"
                imgSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/277feb47ba01fe9f7f34be4d53a5ebb3a5d30a1fa0a076f7e7d7db9d0bd405c4?apiKey=3756b57bedc84c2cbd55485bb12ec63c&"
              />
            </div>
          </div>
